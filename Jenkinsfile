          ...
          stage("QA-Test") {
              ...
              post {
                  ...
                  always {
                      script {
                          if (env.CHANGE_ID) {
                          mail bcc: '', body: readFile("Cashfree.html") 'This is sample file', cc: '', from: '', mimeType: 'text/html', replyTo: 'qa-bots@cashfree.com', subject: 'Test mail', to: 'rohit.kumar@cashfree.com'
